...
public class FormAutoCompleteTextView extends AutoCompleteTextView {
     ...
     */
    public void addValidator(com.quascenta.petersroad.droidtag.Utils.Validator theValidator) throws IllegalArgumentException {
     ...
     * customValidators and call {@link com.quascenta.petersroad.droidtag.Utils.Validator#isValid(EditText)}
     *
